...
/*
	...
	This is ideal for situations where a lot of strings are allocated, and then
	deallocated all at the same time.
...
public:
	...
	RCString(RCString&& orig) : len_(orig.len_) {
		std::swap(p, orig.p);
	}
