/**
	 ...
	 see: https://raw.githubusercontent.com/curl/curl/master/docs/examples/sendrecv.c
	 @author: Dov Kruger
	 April 19, 2018
*/
...
void sendOneRequest(CURL* curl, curl_socket_t sockfd, const char* request, size_t requestLen) {
	int res;
