...
/**
	 Mapping to look up URI and rapidly turn into pointer to the servlet to execute
	 For speed, no memory is allocated during lookup.  The keys can be strings, but
	 lookup is a pointer to char within a buffer and a length
