...
/*
TODO:
  create a definition introducer that automatically defines STRUCT with a unique
ID all later references can simply refer to the ID Vec3d v;
...
int main() {
  ...
  // note: if strict by default should not be able to assign values of type y =
  // Userid
