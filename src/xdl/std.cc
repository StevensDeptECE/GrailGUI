...
void F64::display(Buffer& in, Canvas* c, const Style* s, float x0, float y0,
  ...
  void Timestamp::format(Buffer & binaryIn, Buffer & asciiOut, const char fmt[])
      const {}
  ...
  */
  ...
  void Struct::format(Buffer & binaryIn, Buffer & asciiOut, const char fmt[])
      const {}
  ...
  void TypeDef::format(Buffer & binaryIn, Buffer & asciiOut, const char fmt[])
      const {}
  ...
  void Regex::format(Buffer & binaryIn, Buffer & asciiOut, const char fmt[])
      const {}
