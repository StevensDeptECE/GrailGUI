...
// double slope(Vec3D p1, Vec3D p2){ //copying large objects (slow) const Vec3D&
// p1, const Vec3D& p2
//   return (p2.y - p1.y)/(p2.x - p1.x);
// }
// void Bezier::getEquationX(const Vec3D& p0, const Vec3D& p1, const Vec3D& p2,
// const Vec3D& p3){
...
// void Bezier::getEquationY(const Vec3D& p0, const Vec3D& p1, const Vec3D& p2,
// const Vec3D& p3){
//   dy = p0.y;
//   cy = slope(p0, p1);
//   by = -3*(p3.y) + 3*(p0.y) + 2*(slope(p0, p1)) + slope(p2, p3);
//   ay = p3.y - p0.y - slope(p0, p1) + 3*(p3.y) - 3*(p0.y) - 2*(slope(p0, p1))
//   + slope(p2, p3);
// }

// void Bezier::getEquationZ(const Vec3D& p0, const Vec3D& p1, const Vec3D& p2,
// const Vec3D& p3){
//   dz = p0.z;
//   cz = slope(p0, p1);
//   bz = -3*(p3.z) + 3*(p0.z) + 2*(slope(p0, p1)) + slope(p2, p3);
//   az = p3.z - p0.z - slope(p0, p1) + 3*(p3.z) - 3*(p0.z) - 2*(slope(p0, p1))
//   + slope(p2, p3);
// }

void BezierPath::getEquationX(double t, const Vec3D& p0, const Vec3D& p1,
...
void BezierPath::getEquationY(double t, const Vec3D& p0, const Vec3D& p1,
                              const Vec3D& p2, const Vec3D& p3) {
  double t2 = t * t;
  double t3 = t2 * t;
...
void BezierPath::getEquationZ(double t, const Vec3D& p0, const Vec3D& p1,
                              const Vec3D& p2, const Vec3D& p3) {
  double t2 = t * t;
  double t3 = t2 * t;
