...
class Transform : public Shape {
 private:
  ...
  float x, y, z;
  glm::mat4 transform;
  // to know which type to apply to shape
 ...
 public:
  /*
    ...
    0 0 0 1   1
  */
  Transform(Canvas* c, Shape* shape)
      : Shape(c), c(c), style(nullptr), shape(shape) {
  ...
  */
  ...
  void scale(float s) { transform = glm::scale(transform, glm::vec3(s, s, s)); }
