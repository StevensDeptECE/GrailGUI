...
void Rect::init() {
  ...
  float xy[20] = {
    x, y, r, g, b,    x+width, y, r, g, b,  x+width, y+height, r, g, b,  x, y+height, r, g, b
  };
  glBufferData(GL_ARRAY_BUFFER, 4*5 * sizeof(float), xy, GL_DYNAMIC_DRAW); //TODO: try with GL_STATIC_DRAW. Is it faster?
