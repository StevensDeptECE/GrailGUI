...
class Image : public Shape {
 ...
 public:
  ...
  Image(Canvas* c, float x, float y, float width, float height, char* filePath,
        const Style* s);

  void change(const char* filePath);
  ...
  /*
     ...
     */
  void addImage(float x, float y, float width, float height, float u0 = 0,
                float v0 = 0, float u1 = 1, float v1 = 1);
