...
class StyledMultiShape2D : public MultiShape2D {
 ...
 public:
  ...
  // Solid Primitives
  void fillDrawRectangle(float x, float y, float w, float h,
                         const glm::vec4& fc, const glm::vec4& dc);
  void fillDrawRoundRect(float x, float y, float w, float h, float rx, float ry,
                         const glm::vec4& fc, const glm::vec4& dc);
  void fillDrawTriangle(float x1, float y1, float x2, float y2, float x3,
                        float y3, const glm::vec4& fc, const glm::vec4& dc);
