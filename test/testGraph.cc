...
public:
	void init() {
		...
		CSRGraph<uint64_t, uint64_t, float> cg("res/email-Eu-core.txt_beg_pos.bin", "res/email-Eu-core.txt_csr.bin", nullptr);
		//CSRGraph<uint64_t, uint64_t, float> cg("res/toy.dat_beg_pos.bin", "res/toy.dat_csr.bin", nullptr);
