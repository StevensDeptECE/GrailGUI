...
class TestWidgets : public GLWin {
 public:
  ...
  void testGapMinder(StyledMultiShape2D *gui, MultiText *guiText){
    ...
    vector<glm::vec4> c = {grail::red, grail::blue, grail::green, grail:: cyan, grail::purple, grail::darkblue};
  ...
  void testAngleText(StyledMultiShape2D *gui, MultiText *guiText, Canvas *c, const Style *s) {
